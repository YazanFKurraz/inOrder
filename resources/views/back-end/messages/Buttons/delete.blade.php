                                             {{csrf_field()}}
                                            <a href="javascript:;" id="delete" data-id='{{$message->id }}' onclick="delete_message(this)">
                ...
                $.ajax(
                   {
                    ...
                    data: {
                     ...
                     success: function (data){
                         ...
                         swal("Deleted!", "Message Deleted Succsefully.", "success");
                        }
                });
